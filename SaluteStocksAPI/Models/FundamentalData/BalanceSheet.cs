...
public class BalanceSheetReport
{
    ...
    /// </summary>
    [JsonProperty("totalAssets")] public double? TotalAssets { get; set; }
    
    /// <summary>
    /// балансовая стоимость, запланированная быть потраченной в течении года
    /// </summary>
    [JsonProperty("totalCurrentAssets")] public double? TotalCurrentAssets { get; set; }
    ...
    /// </summary>
    [JsonProperty("cashAndShortTermInvestments")] public double? CashAndShortTermInvestments { get; set; }
    ...
    /// </summary>
    [JsonProperty("inventory")] public double? Inventory { get; set; }
    ...
    /// </summary>
    [JsonProperty("intangibleAssets")] public double? IntangibleAssets { get; set; }
    ...
    /// </summary>
    [JsonProperty("goodwill")] public double? Goodwill { get; set; }
    ...
    /// </summary>
    [JsonProperty("longTermInvestments")] public double? LongTermInvestments { get; set; }
    ...
    /// </summary>
    [JsonProperty("shortTermInvestments")] public double? ShortTermInvestments { get; set; }

    /// <summary>
    /// Сумма оборотных активов, классифицированных как прочие.
    /// </summary>
    [JsonProperty("otherCurrentAssets")] public double? OtherCurrentAssets { get; set; }
    ...
    /// </summary>
    [JsonProperty("totalLiabilities")] public double? TotalLiabilities { get; set; }
    ...
    /// </summary>
    [JsonProperty("shortTermDebt")] public double? ShortTermDebt { get; set; }
    ...
    /// </summary>
    [JsonProperty("longTermDebt")] public double? LongTermDebt { get; set; }
    ...
    /// </summary>
    [JsonProperty("currentLongTermDebt")] public double? CurrentLongTermDebt { get; set; }
    ...
    /// </summary>
    [JsonProperty("treasuryStock")] public double? TreasuryStock { get; set; }

    /// <summary>
    /// Совокупная сумма нераспределенной прибыли или дефицита отчитывающейся организации.
    /// </summary>
    [JsonProperty("retainedEarnings")] public double? RetainedEarnings { get; set; }
    ...
    /// </summary>
    [JsonProperty("commonStock")] public double? CommonStock { get; set; }
