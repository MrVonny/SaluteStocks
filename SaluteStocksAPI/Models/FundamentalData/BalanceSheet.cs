...
public class BalanceSheetReport
{
    ...
    /// </summary>
    [JsonProperty("totalCurrentAssets")] public decimal? TotalCurrentAssets { get; set; }
    ...
    /// </summary>
    [JsonProperty("cashAndShortTermInvestments")] public decimal? CashAndShortTermInvestments { get; set; }
    ...
    /// </summary>
    [JsonProperty("currentNetReceivables")] public decimal? CurrentNetReceivables { get; set; }
    ...
    /// </summary>
    [JsonProperty("intangibleAssets")] public decimal? IntangibleAssets { get; set; }
    ...
    /// </summary>
    [JsonProperty("goodwill")] public decimal? Goodwill { get; set; }

    /// <summary>
    /// Сумма балансовой стоимости на отчетную дату всех инвестиций.
    /// </summary>
    [JsonProperty("investments")] public decimal? Investments { get; set; }
    ...
    /// </summary>
    [JsonProperty("longTermInvestments")] public decimal? LongTermInvestments { get; set; }
    ...
    /// </summary>
    [JsonProperty("shortTermInvestments")] public decimal? ShortTermInvestments { get; set; }

    /// <summary>
    /// Сумма оборотных активов, классифицированных как прочие.
    /// </summary>
    [JsonProperty("otherCurrentAssets")] public decimal? OtherCurrentAssets { get; set; }
    ...
    /// </summary>
    [JsonProperty("deferredRevenue")] public decimal? DeferredRevenue { get; set; }
    ...
    /// </summary>
    [JsonProperty("currentDebt")] public decimal? CurrentDebt { get; set; }
    ...
    /// </summary>
    [JsonProperty("shortTermDebt")] public decimal? ShortTermDebt { get; set; }
    ...
    /// </summary>
    [JsonProperty("longTermDebt")] public decimal? LongTermDebt { get; set; }
    ...
    /// </summary>
    [JsonProperty("currentLongTermDebt")] public decimal? CurrentLongTermDebt { get; set; }
    ...
    /// </summary>
    [JsonProperty("treasuryStock")] public decimal? TreasuryStock { get; set; }

    /// <summary>
    /// Совокупная сумма нераспределенной прибыли или дефицита отчитывающейся организации.
    /// </summary>
    [JsonProperty("retainedEarnings")] public decimal? RetainedEarnings { get; set; }
    ...
    /// </summary>
    [JsonProperty("commonStock")] public decimal? CommonStock { get; set; }
