...
public class IncomeStatementReport
{
    ...
    /// </summary>
    [JsonProperty("grossProfit")] public decimal? GrossProfit { get; set; }
    ...
    /// </summary>
    [JsonProperty("costOfRevenue")] public decimal? CostOfRevenue { get; set; }
    ...
    /// </summary>
    [JsonProperty("operatingIncome")] public decimal? OperatingIncome { get; set; }
    ...
    /// </summary>
    [JsonProperty("operatingExpenses")] public decimal? OperatingExpenses { get; set; }
    ...
    /// </summary>
    [JsonProperty("investmentIncomeNet")] public decimal? InvestmentIncomeNet { get; set; }

    /// <summary>
    /// Чистая сумма операционных процентных доходов (расходов).
    /// </summary>
    [JsonProperty("netInterestIncome")] public decimal? NetInterestIncome { get; set; }

    /// <summary>
    /// Сумма процентного дохода.
    /// </summary>
    [JsonProperty("interestIncome")] public decimal? InterestIncome { get; set; }

    /// <summary>
    /// Сумма стоимости заемных средств, учитываемая как процентный расход.
    /// </summary>
    [JsonProperty("interestExpense")] public decimal? InterestExpense { get; set; }
    ...
    /// </summary>
    [JsonProperty("nonInterestIncome")] public decimal? NonInterestIncome { get; set; }
    ...
    /// </summary>
    [JsonProperty("depreciation")] public decimal? Depreciation { get; set; }
    ...
    /// </summary>
    [JsonProperty("incomeBeforeTax")] public decimal? IncomeBeforeTax { get; set; }
    ...
    /// </summary>
    [JsonProperty("incomeTaxExpense")] public decimal? IncomeTaxExpense { get; set; }
    ...
    /// </summary>
    [JsonProperty("ebit")] public decimal? Ebit { get; set; }
    ...
    /// </summary>
    [JsonProperty("netIncome")] public decimal? NetIncome { get; set; }
}
