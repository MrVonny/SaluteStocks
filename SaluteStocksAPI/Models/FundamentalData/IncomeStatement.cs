...
{
    [JsonProperty("grossProfit")] public string GrossProfit { get; set; }

    [JsonProperty("totalRevenue")] public string TotalRevenue { get; set; }

    [JsonProperty("costOfRevenue")] public string CostOfRevenue { get; set; }

    [JsonProperty("costofGoodsAndServicesSold")]
    public string CostofGoodsAndServicesSold { get; set; }

    [JsonProperty("operatingIncome")] public string OperatingIncome { get; set; }
    ...
    [JsonProperty("operatingExpenses")] public string OperatingExpenses { get; set; }

    [JsonProperty("investmentIncomeNet")] public string InvestmentIncomeNet { get; set; }

    [JsonProperty("netInterestIncome")] public string NetInterestIncome { get; set; }

    [JsonProperty("interestIncome")] public string InterestIncome { get; set; }

    [JsonProperty("interestExpense")] public string InterestExpense { get; set; }

    [JsonProperty("nonInterestIncome")] public string NonInterestIncome { get; set; }

    [JsonProperty("otherNonOperatingIncome")]
    public string OtherNonOperatingIncome { get; set; }

    [JsonProperty("depreciation")] public string Depreciation { get; set; }

    [JsonProperty("depreciationAndAmortization")]
    public string DepreciationAndAmortization { get; set; }

    [JsonProperty("incomeBeforeTax")] public string IncomeBeforeTax { get; set; }

    [JsonProperty("incomeTaxExpense")] public string IncomeTaxExpense { get; set; }
    ...
    [JsonProperty("ebit")] public string Ebit { get; set; }
